...
Source0  : https://mirrors.kernel.org/gnu/diffutils/diffutils-3.11.tar.gz
Source1  : https://mirrors.kernel.org/gnu/diffutils/diffutils-3.11.tar.gz.sig
...
%setup -q -n diffutils-3.11
cd %{_builddir}/diffutils-3.11
pushd ..
cp -a diffutils-3.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738596612
