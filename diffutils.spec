...
Version  : 3.12
Release  : 34
URL      : https://mirrors.kernel.org/gnu/diffutils/diffutils-3.12.tar.gz
Source0  : https://mirrors.kernel.org/gnu/diffutils/diffutils-3.12.tar.gz
Source1  : https://mirrors.kernel.org/gnu/diffutils/diffutils-3.12.tar.gz.sig
...
%setup -q -n diffutils-3.12
cd %{_builddir}/diffutils-3.12
pushd ..
cp -a diffutils-3.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744174566
